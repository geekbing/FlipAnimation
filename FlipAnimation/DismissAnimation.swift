...
class DismissAnimation: NSObject, UIViewControllerAnimatedTransitioning
{
    ...
    {
        // 获取动画的源控制器和目标控制器，注意顺序
        let fromVC = transitionContext.viewControllerForKey(UITransitionContextFromViewControllerKey) as! Second
        let toVC = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as! First
